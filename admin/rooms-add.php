...
// Set page title
$page_title = 'Add Rooms - RoundTours';
$active_page = 'rooms';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO rooms (hotel_id, room_type, amenities, description, price, discount, main_img_url, num_adults, num_children) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
            ...
            header('Location: rooms-view.php?created=1');
            exit;
        } else {
            $errors[] = "Error creating room: " . $conn->error;
        }
    }
}
        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-4 text-end">
                    <a href="rooms-add.php" class="btn btn-secondary">Cancel</a>
