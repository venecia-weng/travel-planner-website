...
// Set page title
$page_title = 'Add Flights - RoundTours';
$active_page = 'flights';
...
$flight_data = [
    ...
    'premium_economy_seats_available' => '',
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO flights (airline_id, flight_number, origin, destination, departure_date_time, 
            arrival_date_time, economy_price, premium_economy_price, business_price, first_class_price, economy_seats_available, 
            premium_economy_seats_available, business_seats_available, first_class_seats_available) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
            ...
            header('Location: flights-view.php?created=1');
            exit;
        } else {
            $errors[] = "Error creating flight: " . $conn->error;
        }
    }
}
        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-4 text-end">
                    <a href="flights-add.php" class="btn btn-secondary">Cancel</a>
